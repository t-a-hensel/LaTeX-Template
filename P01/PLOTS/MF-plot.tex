...
\begin{tikzpicture}%[x=1cm,y=1cm,scale=1.0]
    \begin{groupplot}[group style={group size= 2 by 2
    					...
    					,legend style={nodes={scale=0.8, transform shape}}	,xtick={0,0.25,0.5,0.75,1,9.,9.25,9.5,9.75,10}
    					]
        \nextgroupplot[xmin=0
        				,xmax=1.0
        				,ymin=2*10^7
                ...
                %\node [text width=2em,anchor=north west] at (rel axis cs: -0.05,1.05)
                %{\captionof{figure}{}\label{fig:density-plot}};
        \nextgroupplot[xmin=9.
        				,xmax=10.
        				,ymin=2*10^7
        				,ymax=3*10^12
        ...
        \nextgroupplot[xmin=0
                ...
                %{\subcaption{}\label{fig:sigma-MF-plot}};
