...
\documentclass[11pt, english, fleqn, DIV=15, headinclude, BCOR=2cm, twoside]{scrartcl}
%\documentclass[11pt,twoside,a4paper]{article}
\usepackage[a4paper,left=2cm,right=1cm,top=2.0cm,bottom=2.5cm,bindingoffset=0mm]{geometry}
