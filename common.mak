...
#if false, this prints the current git commit hash into the header
SUBMISSIONBUILD=true
#title of the pdf document, does not change the LaTeX \title.
TITLE=Template
...
# if one has output from the Python program but does not want to typeset the
# report.
